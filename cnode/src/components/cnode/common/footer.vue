    ...
    <div id="footer">
      <div class="main">
        ...
        <p>服务器赞助商为
          ...
          存储赞助商为<a href="http://www.qiniu.com/?ref=cnode" target="_blank" class="sponsor_outlink" data-label="qiniu_bottom">
      ...
      <img src="//dn-cnode.qbox.me/FpMZk31PDyxkC8yStmMQL4XroaGD" title="alinode" alt="alinode" height="54px" width="166px">
        ...
        <p>新手搭建 Node.js 服务器，推荐使用无需备案的 <a href="www.digitalocean.com/">DigitalOcean(https://www.digitalocean.com/)</a> </p>
      </div>
    </div>
</template>
